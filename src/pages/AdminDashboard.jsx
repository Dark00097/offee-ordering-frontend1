...
function AdminDashboard() {
  ...
  const fetchAnalyticsData = useCallback(async () => {
    ...
    try {
      ...
      const res = await api.get('/analytics-overview', { params: sanitizedFilters });
      setAnalyticsData(res.data);
    } catch (error) {
      console.error('Error fetching analytics data:', error.response?.data || error);
      toast.error(error.response?.data?.details || error.response?.data?.error || 'Failed to fetch analytics data');
      setAnalyticsData({
